...
\[
\approx 1^2 + 2 \times 1 \times 0.05 = 1.10
\]

\vspace{2em}

\subsection{Compute $\sqrt{256.016}$}
\subsection*{Answer}
$f(x) = \sqrt{x}$\\

\[
\approx \sqrt{256} + \dfrac{1 \times 0.16}{2 \times \sqrt{256}} = 16 + \dfrac{16 \times 10^{-3}}{2 \times 16} = 16.0005
\]

\vspace{2em}

\subsection{Compute $\dfrac{2}{\sqrt{0.99} + 0.99^2 + 0.99}$}
\subsection*{Answer}

$f(x) = \dfrac{2}{\sqrt{x} + x^2 + x}$ and $x = 1, \Delta x = -0.01$

\[
\approx \dfrac{2}{\sqrt{1} + 1^2 + 1} - \dfrac{2 \times \frac{7}{2}}{9} \times (-0.01) = \dfrac{6.07}{9} = 0.674
\]
